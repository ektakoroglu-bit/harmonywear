...
export const TURKEY_CITIES: CityData[] = [
  ...
  {
    name: 'Aksaray',
    districts: ['Ağaçören', 'Eskil', 'Gülağaç', 'Güzelyurt', 'Merkez', 'Ortaköy', 'Sarıyahşi', 'Sultanhanlı'],
  },
  {
    name: 'Amasya',
  ...
  {
    name: 'Samsun',
    districts: ['Alaçam', 'Asarcık', 'Atakum', 'Ayvacık', 'Bafra', 'Canik', 'Çarşamba', 'İlkadım', 'Kavak', 'Ladik', '19 Mayıs', 'Ondokuzmayıs', 'Salıpazarı', 'Tekkeköy', 'Terme', 'Vezirköprü', 'Yakakent'],
  },
  {
    name: 'Siirt',
